...
public class DeletarRelationshipIssuesRequest extends RequestRestBase {

    public DeletarRelationshipIssuesRequest(String idIssue, String idRelationship) {
        requestService = "/api/rest/issues/" + idIssue + "/relationships/" + idRelationship;
